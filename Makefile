...
DEP_RELEASE = 
OUT_RELEASE = bin/Release/bd

OBJ_DEBUG = $(OBJDIR_DEBUG)/Commands.o $(OBJDIR_DEBUG)/main.o

OBJ_RELEASE = $(OBJDIR_RELEASE)/Commands.o $(OBJDIR_RELEASE)/main.o
